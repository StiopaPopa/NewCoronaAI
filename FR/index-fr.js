...
window.onload = function () {
  ...
  // french url
  const baseUrl =
    "https://westus.api.cognitive.microsoft.com/luis/prediction/v3.0/apps/35d14feb-87d1-42f7-a13d-c0f5ebdd9260/slots/production/predict?subscription-key=555f8d82328c4797bd152dc634703fc0&verbose=true&show-all-intents=true&log=true&query=";
  ...
  casesAgo.addEventListener("click", () => {
    input.value = "nouveaux cas il y a 4 jours";
    handleSearch();
  });
  covidSymptoms.addEventListener("click", () => {
    input.value = "symptômes COVID";
    handleSearch();
  });
  vaccineInformation.addEventListener("click", () => {
    input.value = "informations sur les vaccins";
    handleSearch();
  });
